...
<tr>
		...
		<th id="cab" onclick="sortTable_recu(2)">DESCRIPCION</th>
...
<?php
	...
	$paginador_res=paginador_recurso ($conn);
	...
	$resultado =paginador_recurso2($conn,$desde,$num_pag);

	if($resultado > 0)
	{	$query=llenar_tabla_recurso($conn,$desde,$num_pag);
