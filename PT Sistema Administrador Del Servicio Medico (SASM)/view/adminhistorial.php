...
<form action="buscar_historial.php" method="get">
...
<?php	
	...
	$paginador_res=pagindor_historial($conn);
	...
	$resultado =llenar_tabla_historial ($conn,$desde,$num_pag);

	if($resultado > 0)
	{	$query=llenar_tabla_historial2 ($conn,$desde,$num_pag);
