...
$busqueda =strtolower($_REQUEST['busqueda']);
	if (empty($busqueda)) 
	{
		header('Location: adminmedicina.php');
	}
?>
...
<?php
	...
	$paginador_res=paginador_buscar_medicina($conn,$busqueda);
	...
	$resultado =buscar_medicina($conn,$busqueda,$desde,$num_pag);

	if($resultado > 0)
	{	$query=buscar_medicina2($conn,$busqueda,$desde,$num_pag);
